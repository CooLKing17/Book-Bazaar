...
import SimmerEff from "./SimmerEff";
const list = [
...
const CataBookList=()=>{
return(
<div className=" mt-20 px-4 rounded-xl border-2 border-blue-500 m-3">
<h1 className=" text-center font-serif bg-green-500 rounded-full m-2 font-bold text-3xl p-2">Type</h1>
{list.map((li)=>(
!li ? (
