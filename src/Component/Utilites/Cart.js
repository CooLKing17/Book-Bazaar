const Cart = () => {
    return (
      <div className="mt-20 px-4 border-2 rounded-xl border-green-500 m-2 p-4">
        <h1 className="text-2xl font-serif font-bold mb-4 text-center">My Shopping Cart</h1>
        {/* map function */}
        <div className="flex justify-between items-center border-2 border-red-400 p-4 rounded-md bg-white shadow-sm">
