  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const bookResponse = await axios.post(
        `${server}/sellBook/api/BookAdd/${userID}`,
        formData
      );
      ...
      // Upload images
      await axios.post(`${server}/sellBook/api/uploadImage/${bookId}`, data, {
        headers: {
          "Content-Type": "multipart/form-data",
        },
      });

      toast.success("image and book details upload successfully");
      navigate("/");
    } catch (error) {
          ...
          <form onSubmit={handleSubmit}>
            ...
            {formData.bookCondition === "Used" && (
              <div className="mb-5">
                ...
                <select
                  name="oldbookcondition"
                  value={formData.oldbookcondition}
                  onChange={handleInputChange}
                  className="w-full border border-gray-300 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-50"
                >
                  <option value="">Select an option</option>
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-600 mt-2">
                You can upload up to 5 images, each image under 1MB, in JPG
                format.
              </p>
            </div>
            <button
